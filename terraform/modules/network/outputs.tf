...
output "alb_dns_name" {
  ...
  description = "Public DNS name of the Application Load Balancer (used as CloudFront origin)"
}

output "alb_target_group_arn" {
  value       = aws_lb_target_group.api_tg.arn
  description = "ARN of the ALB Target Group to attach EC2 instances to in the compute module"
}
